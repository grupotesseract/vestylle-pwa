...
Se pedimos por suas informações pessoais por uma razão secundária, como marketing, vamos lhe pedir diretamente por seu consentimento, ou lhe fornecer a oportunidade de dizer não. E caso você queira retirar seu consentimento, como proceder? Se após você nos fornecer seus dados, você mudar de ideia, você pode retirar o seu consentimento para que possamos entrar em contato, para a coleção de dados contínua, uso ou divulgação de suas informações, a qualquer momento, entrando em contato conosco em edilson.bauru@gmail.com ou nos enviando uma correspondência em: 2T Rua Edmundo Antunes, 3-79, Vila Nova Cidade Universitaria, Bauru, SP
</RubikText>
<RubikText style={styles.textoTitulo}>SEÇÃO 3 - DIVULGAÇÃO</RubikText>
<RubikText style={styles.textoBranco}> 

Podemos divulgar suas informações pessoais caso sejamos obrigados pela lei para fazê-lo ou se você violar nossos Termos de Serviço.
</RubikText>
<RubikText style={styles.textoTitulo}>SEÇÃO 4 - SERVIÇOS DE TERCEIROS</RubikText>
<RubikText style={styles.textoBranco}> 
...
<RubikText style={styles.textoTitulo}>SEÇÃO 5 - SEGURANÇA</RubikText>
<RubikText style={styles.textoBranco}> 
...
<RubikText style={styles.textoTitulo}>SEÇÃO 6 - ALTERAÇÕES PARA ESSA POLÍTICA DE PRIVACIDADE</RubikText>
